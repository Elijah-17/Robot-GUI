...
def sliders():
    ...
    box2_percent.place(x=780, y=130)
    ...
    box3_percent.place(x=780, y=230)
    ...
    box4_percent.place(x=780, y=330)
    ...
    box5_percent.place(x=780, y=430)
    ...
    box6_percent.place(x=780, y=530)
